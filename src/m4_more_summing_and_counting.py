...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 1
    answer = count_cosines_from(2, 5, 0.12)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 4
    answer = count_cosines_from(1, 7, -0.20)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(3, 5, 0.45)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(7, 10, 0.33)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.28333333  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 5)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 2.08333333  # This is APPROXIMATELY the correct answer.
